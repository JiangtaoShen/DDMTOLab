...
class RVEA:
    ...
    def __init__(self, problem, n=None, max_nfes=None, alpha=2.0, fr=0.1, save_data=True, save_path='./Data',
                 name='RVEA', disable_tqdm=True):
        """
        ...
        name : str, optional
            Name for the experiment (default: 'RVEA')
