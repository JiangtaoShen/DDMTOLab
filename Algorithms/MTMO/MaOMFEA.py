"""
Many-objective Multifactorial Evolutionary Algorithm (MaO-MFEA)

This module implements MaO-MFEA for many-objective multi-task optimization with knowledge transfer.
...
class MaOMFEA:
    """
    Many-objective Multifactorial Evolutionary Algorithm for many-objective multi-task optimization.
    ...
    def __init__(self, problem, n=None, max_nfes=None, rmp=0.3, save_data=True, save_path='./Data',
                 name='maomfea_test', disable_tqdm=True):
        """
        Initialize MaOMFEA algorithm.
        ...
        name : str, optional
            Name for the experiment (default: 'maomfea_test')
...
def maomfea_selection(all_decs, all_objs, all_cons, all_sfs, n, nt):
    """
    Environmental selection for MaOMFEA using constraint-first and NSGA-II-SDR criteria.
