...
class PKACP:
    ...
    data_dir : str, optional
        Directory path for storing/loading task parameters
        (default: '../Problems/RWP/PKACP')

    Attributes
    ----------
    data_dir : str
        Directory for task parameter files
    """

    def __init__(self, data_dir='../Problems/RWP/PKACP'):
        """
