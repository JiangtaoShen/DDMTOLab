...
class SCP:
    ...
    References
    ----------
    [1] M. L. Ryerkerk et al., "Solving Metameric Variable-length Optimization
        Problems Using Genetic Algorithms," Genetic Programming and Evolvable
        Machines, vol. 18, no. 2, pp. 247-277, 2017.
    [2] G. Li et al., "Evolutionary Competitive Multitasking Optimization,"
    ...
    mat_path : str, optional
        ...
        (default: 'Problems/RWP/SCP/SCP_Adata.mat')
    ...
    def __init__(self, mat_path='../Problems/RWP/SCP/SCP_Adata.mat',
                 Nmin=25, Nmax=35):
        """
